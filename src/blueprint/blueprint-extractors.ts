...
export const extractTextFilter = async (
...
export const extractAttr = async (
    adapter: ExtractionAdapter,
    field: FieldDef
): Promise<string | null> => {
 ...
 */
export const extractAttrList = async (
    adapter: ExtractionAdapter,
    field: FieldDef
 ...
 */
export const extractTextGroupList = async (
    adapter: ExtractionAdapter,
    field: FieldDef
 ...
 */
export const extractKeyValueTable = async (
    adapter: ExtractionAdapter,
    field: FieldDef
